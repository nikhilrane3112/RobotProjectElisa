...
def write_excel(path,CaseName,CR,Order,Subscriber,status):
   # Workbook is created 
    wb = Workbook() 
   ...
   # add_sheet is used to create sheet. 
    ...
    sheet1.write(row, 1, CR) 
    sheet1.write(row, 2, Order) 
...
if __name__ == "__main__":
     path = "C://Users//nikhiran//Desktop//Newlankanumero.xls"
#     #open_file(path)
#     Write_Regular_Data_To_Sheet(path)
     open_file(path,1,1,"TestData_Subscriber")
