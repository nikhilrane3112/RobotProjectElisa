...
Validate Salesforce Lightning URL and go to Terminate subscription
    ...
    Execute Javascript    document.evaluate("//ul[contains(@class,'lookup__list')]/li[1]/a", document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null).snapshotItem(0).click();
    #Sleep                            3 
    Wait Until Page Contains Element    xpath=(//*[@class='slds-table forceRecordLayout slds-table--header-fixed slds-table--edit slds-table--bordered resizable-cols slds-table--resizable-cols uiVirtualDataTable'])/tbody/tr[1]/th/span/a    60   
    Wait Until Element Is Visible    xpath=(//*[@class='slds-table forceRecordLayout slds-table--header-fixed slds-table--edit slds-table--bordered resizable-cols slds-table--resizable-cols uiVirtualDataTable'])/tbody/tr[1]/th/span/a    60 
    Click Element                    xpath=(//*[@class='slds-table forceRecordLayout slds-table--header-fixed slds-table--edit slds-table--bordered resizable-cols slds-table--resizable-cols uiVirtualDataTable'])/tbody/tr[1]/th/span/a
