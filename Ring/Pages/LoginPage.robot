...
Move to another Account
    ...
    Select From List By Label    id=fcf    Elisa Sales Agent
    Wait Until Page Contains Element    xpath=(//*[text()='Aarnio, Niki'])    60
    Click Element    xpath=(//*[text()='Aarnio, Niki'])//preceding::a[1]
